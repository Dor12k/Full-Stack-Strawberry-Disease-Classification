...
function Home() {
  ...
  return (
    ...
    <div  className="flex flex-col min-h-screen">
        ...
        <section className="flex-1 h-[500px] bg-[#ffe6c1db] dark:bg-[#1f1f1f] text-black dark:text-white py-16 px-6 sm:px-12 transition-colors duration-500">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-stretch max-w-screen-xl mx-auto px-6 py-2 w-full">
                ...
                {imagePreview ? 
                (
                    <div className="flex flex-col justify-between bg-[#fff8ef] dark:bg-[#2a2a2a] p-4 lg:p-8 rounded-[30px] shadow-lg flex-1 h-[500px]">
                        ...
                        <div className="w-full flex-1 border-2 border-dashed border-[#bbb5ff] bg-[#f7f8ff] rounded-[20px] flex flex-col items-center justify-center text-center dark:border-[#2a2a2a] dark:bg-[#2a2a2a]">
                            ...
                            <img alt="Upload" src={imagePreview} className="w-full max-h-[200px] sm:max-h-[400px] md:max-h-[290px] rounded-t-[20px]" />      
                                ...
                                (
                                    ...
                                    <div className="w-full mx-2 my-2 lg:text-2xl sm:text-lg">
                    ...
                    <form id="drop-area" method="POST" encType="multipart/form-data" onDragOver={handleDragOver} onDragLeave={handleDragLeave} onDrop={handleDrop}
                          className={`flex-[1] rounded-[30px] p-4 lg:p-8 bg-white dark:bg-[#2a2a2a] shadow-lg w-full max-w-md ${isDragging ? 'bg-blue-100 dark:bg-blue-900 border-blue-500' : 'bg-white dark:bg-[#2a2a2a]'} transition-all duration-300 `}>
